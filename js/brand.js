...
const brand = {
    app: {
        name: 'Rafu Connect',
        title: 'Rafu Connect <br/> Ultimate Encrypted Meeting.',
        description:
            'Start your next video call with a single click. No download, plug-in, or login is required. Just get straight to talking, messaging, and sharing your screen.',
    },
    site: {
        landingTitle: 'Rafu Connect | Free Secure Video Calls, Chat & Screen Sharing.',
        newCallTitle: 'Rafu Connect | Free Secure Video Calls, Chat & Screen Sharing.',
        loginTitle: 'Rafu Connect - Host Protected login required.',
        clientTitle: 'Rafu Connect WebRTC Video call, Chat Room & Screen Sharing.',
        privacyPolicyTitle: 'Rafu Connect - privacy and policy.',
        stunTurnTitle: 'Test Stun/Turn Servers.',
        notFoundTitle: 'Rafu Connect - 404 Page not found.',
        shortcutIcon: '../images/logo/logo.png',

...
const ZOOM_IN_OUT_ENABLED = false; // Video Zoom in/out default (true)
...
let surveyURL = 'https://g.page/r/CV46CyoD9xEVEB0/review';
...
async function whoAreYou() {
    ...
    Swal.fire({
        ...
        confirmButtonText: `Join The Meeting`,
        confirmButtonColor: "#b17b00",
        customClass: {
            popup: 'init-modal-size',
            confirmButton: 'custom-confirm-button' // Add custom class for the confirm button
        },
        showClass: { popup: 'animate__animated animate__fadeInDown' },
        hideClass: { popup: 'animate__animated animate__fadeOutUp' },
...
function setButtonsBarPosition(position) {
    ...
    switch (mainButtonsBarPosition) {
        case 'vertical':
            // Main buttons bar - Vertically aligned on the left
            setSP('--btns-top', '50%'); // Middle of the screen
            setSP('--btns-right', 'auto');
            setSP('--btns-left', '10px'); // Left position
            setSP('--btns-margin-left', '0px');
            setSP('--btns-width', '40px');
            setSP('--btns-flex-direction', 'column'); // Vertically aligned buttons

            // Bottom buttons bar - Horizontally aligned at the bottom
            setSP('--bottom-btns-top', 'auto');
            setSP('--bottom-btns-left', '50%');
            setSP('--bottom-btns-bottom', '0'); // Bottom position
            setSP('--bottom-btns-translate-X', '-50%');
            setSP('--bottom-btns-translate-Y', '0%');
            setSP('--bottom-btns-margin-bottom', '16px');
            setSP('--bottom-btns-flex-direction', 'row'); // Horizontally aligned buttons
            break;

        case 'horizontal':
            // Main buttons bar - Horizontally aligned, slightly below the top
            setSP('--btns-top', '30px'); // Slightly below top
            setSP('--btns-right', 'auto');
            setSP('--btns-left', '50%');
            setSP('--btns-margin-left', '-260px'); // Centering the buttons
            setSP('--btns-width', '520px');
            setSP('--btns-flex-direction', 'row'); // Horizontally aligned buttons
...
function handleVideoPlayerFs(videoId, videoFullScreenBtnId, peer_id = null) {
    ...
    videoPlayer.style.pointerEvents = 'none';   // remove onClick event
...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our Rafu Connect P2P Video Chat Meeting`;
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=Rafu Connect P2P info"> 
                miroslav.pejic.85@gmail.com
            </a>
            <br /><br />
            <hr />
            <span>&copy; 2024 Rafu Connect P2P, all rights reserved</span>
            <hr />
        </div>
        `,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your Rafu Connect experience?',
        confirmButtonText: `Yes`,
        denyButtonText: `No`,
        confirmButtonColor: "#b17b00",
        showClass: { popup: 'animate__animated animate__fadeInDown' },
